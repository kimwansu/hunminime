...
public class LatinKeyboard extends Keyboard
{
    ...
    public LatinKeyboard(Context context, int xmlLayoutResId, int mode)
    {
        ...
        mShiftLockIcon = context.getResources().getDrawable(R.drawable.sym_keyboard_shift_locked);
        mShiftLockPreviewIcon =
                context.getResources().getDrawable(R.drawable.sym_keyboard_feedback_shift_locked);
        mShiftLockPreviewIcon.setBounds(0, 0, mShiftLockPreviewIcon.getIntrinsicWidth(),
        ...
        if (null != mEnterKey) {
            ...
            default:
                if (mode == KeyboardSwitcher.MODE_IM) {
                    ...
                    mEnterKey.iconPreview =
                            res.getDrawable(R.drawable.sym_keyboard_feedback_return);
    ...
    static class LatinKey extends Keyboard.Key
    {
        ...
        /**
         * Overriding this method so that we can reduce the target area for
         * certain keys.
         */
        @Override
        public boolean isInside(int x, int y)
        {
            if ((edgeFlags & Keyboard.EDGE_BOTTOM) != 0 || codes[0] == KEYCODE_SHIFT
